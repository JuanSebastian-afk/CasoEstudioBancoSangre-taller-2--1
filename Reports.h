...
Responsabilidades:
    ...
    - Ofrece datos estadisticos sobre el número de chocoanos con tipo de sangre A+,
      el número de araucanos con tipo de sangre O- y el número de caucanos con 
      tipo de sangre B+
    - ofrece datos estadisticos sobre la edad promedio de los donantes del Choco, 
      Arauca y Valle del Cauca.
    - ofrece datos estadisticos sobre la cantidad de vallecaucanos con tipo de 
...
Colaboradores:
    - Usa la clase BloodDatabase importando su vector de donantes para calcular
      los datos estadisticos de sus responsabilidades.
*/
